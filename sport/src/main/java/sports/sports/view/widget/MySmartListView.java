...
public class MySmartListView extends ListView implements OnScrollListener {
	...
	public interface DynamicListViewListener {
		 ...
		 */
		public boolean onRefreshOrMore(MySmartListView dynamicListView, boolean isRefresh);
	}
	...
	public MySmartListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initThis(context);
	}

	public MySmartListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initThis(context);
	}

	public MySmartListView(Context context) {
		super(context);
		initThis(context);
	}
