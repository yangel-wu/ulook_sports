...
public class FavorLayout extends RelativeLayout{
    ...
    private AnimatorSet getEnterAnimtor(final View target) {
        ...
        ObjectAnimator scaleX = ObjectAnimator.ofFloat(target, View.SCALE_X, 1f, 1f);
        ObjectAnimator scaleY = ObjectAnimator.ofFloat(target, View.SCALE_Y, 1f, 1f);
    ...
    private ValueAnimator getBezierValueAnimator(View target) {
        ...
        ValueAnimator animator = ValueAnimator.ofObject(evaluator,new PointF(dp2px(47),dp2px(306)),new PointF(random.nextInt(dp2px(133)),0));
    ...
    private PointF getPointF(int scale) {
        ...
        pointF.x = random.nextInt(300);//减去100 是为了控制 x轴活动范围,看效果 随意~~
        //再Y轴上 为了确保第二个点 在第一个点之上,我把Y分成了上下两半 这样动画效果好一些  也可以用其他方法
        pointF.y = random.nextInt((400))/scale;
        return pointF;
    }
