...
public class CropView_zheng extends ImageView {
    ...
    public CropView_zheng(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
        initCropView();
    }

    public CropView_zheng(Context context, AttributeSet attrs, int defStyle) {
...
//		leftTop.set(0 ,(getHeight()-center.y)/2);
//		rightBottom.set( getWidth()/3, leftTop.y+getWidth());
